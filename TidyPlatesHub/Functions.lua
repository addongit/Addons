...
local ScaleFunctionsDamage = { DummyFunction, ScaleFunctionByElite, ScaleFunctionByTarget, ScaleFunctionByThreatHigh, ScaleFunctionByActiveDebuffs, ScaleFunctionByEnemy,ScaleFunctionByNPC}
local ScaleFunctionsTank = { DummyFunction, ScaleFunctionByElite, ScaleFunctionByTarget, ScaleFunctionByThreatLow, ScaleFunctionByActiveDebuffs, ScaleFunctionByEnemy, ScaleFunctionByNPC}
...
local AlphaFunctionsDamage = { DummyFunction, AlphaFunctionByThreatHigh, AlphaFunctionByMouseover, AlphaFunctionByActiveDebuffs, AlphaFunctionByEnemy, AlphaFunctionByNPC, }
local AlphaFunctionsTank = { DummyFunction, AlphaFunctionByThreatLow, AlphaFunctionByMouseover, AlphaFunctionByActiveDebuffs, AlphaFunctionByEnemy, AlphaFunctionByNPC, }
...
local function AddThreatWidget(plate, enable, config)
	...
	elseif plate.widgets.ThreatWidget then 
		plate.widgets.ThreatWidget:Hide()
		plate.widgets.ThreatWidget = nil
	end
end
