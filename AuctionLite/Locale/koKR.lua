...
L["Add an Item"] = "물품 추가" -- Needs review
L["Advanced"] = "추가기능"
L["Always"] = "항상 표시"
...
L["Auction scan skipped (control key is down)"] = "경매장 검색 건너뜀 (컨트롤키가 눌려짐)"
L["AuctionLite"] = "경매도우미"
...
L["Bid Undercut (Fixed)"] = "입찰가 보다 저가로 내림 (고정가)" -- Needs review
...
L["Buyout Undercut (Fixed)"] = "구입가 보다 저가로 내림 (고정가)" -- Needs review
...
L["Consider Resale Value When Buying"] = "구매할때 재판매 가격 고려"
L["Consider resale value of excess items when filling an order on the \"Buy\" tab."] = "\"구매\"탭의 순서를 작성하면 초과하는 상품의 재판매 가격 고려하십시오."
...
L["Full Scan"] = "전체 검색"
L["Full Stack"] = "최대 묶음"
L["Hide Tooltips"] = "툴팁 숨김" -- Needs review
...
L["Listing %d of %d"] = "목록 %d of %d" -- Needs review
L["Listings"] = "품목"
L["Market Price"] = "시세"
L["Max Stacks"] = "최대 묶음" -- Needs review
L["Max Stacks + Excess"] = "최대 묶음 + 초과" -- Needs review
...
L["Number of stacks suggested when an item is first placed in the \"Sell\" tab."] = " Number of stacks suggested when an item is first placed in the \"Sell\" tab."
L["On the summary view, show how many listings/items are yours."] = "요약 보기에서 목록/품목은 몇개나 보여줄까요"
L["One Item"] = "One Item"
...
L["Placement of tooltips in \"Buy\" and \"Sell\" tabs."] = "\\\"Buy\\\" 과 \\\"Sell\\\" 탭에 툴팁을 배치합니다." -- Needs review
...
L["Selected Stack Size"] = "선택된 묶음 크기" -- Needs review
...
L["Show How Many Listings are Mine"] = " Show How Many Listings are Mine"
