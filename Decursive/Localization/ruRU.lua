...
if not L then
    T._LoadedFiles["ruRU.lua"] = "2.7.0_beta_1";
    return;
end;
...
L["OPT_CREATE_VIRTUAL_DEBUFF_DESC"] = "Позволяет вам увидеть, как будет всё это выглядеть, когда будет обнаружено заражение" -- Needs review
L["OPT_CUREPETS_DESC"] = "Питомцы будут отображаться и излечиваться"
L["OPT_CURE_PRIORITY_NUM"] = "Приоритет #%d" -- Needs review
L["OPT_CURINGOPTIONS"] = "Настройки лечения" -- Needs review
L["OPT_CURINGOPTIONS_DESC"] = "Настроить различные аспекты процесса лечения" -- Needs review
...
L["OPT_CURINGORDEROPTIONS"] = "Настройки порядка лечения" -- Needs review
...
L["OPT_INPUT_SPELL_BAD_INPUT_DEFAULT_SPELL"] = "Decursive уже работает с этим заклинанием. Щелкните с Shift по заклинанию или введите его ID для добавления специального ранга." -- Needs review
...
L["OPT_MFSETTINGS"] = "Настройки микро-фреймов игроков" -- Needs review
L["OPT_MFSETTINGS_DESC"] = "Настройка микро-фреймов игроков" -- Needs review
...
L["OPT_OPTIONS_DISABLED_WHILE_IN_COMBAT"] = "Эти настройки отключаются во вреия боя." -- Needs review
