...
if not L then
    T._LoadedFiles["ruRU.lua"] = "2.6.1_beta_3";
    return;
end;
...
(Для перемещения этого списка переместите панель Decursive, /dcrshow и alt+клик левой кнопкой для изменения положения)]=] -- Needs review
...
L["OPT_AUTOHIDEMFS"] = "Автоскрытие" -- Needs review
...
L["OPT_HIDEMFS_GROUP"] = "Один/в группе" -- Needs review
...
L["OPT_HIDEMFS_SOLO"] = "Один" -- Needs review
