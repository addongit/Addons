...
if not L then 
    T._LoadedFiles["frFR.lua"] = "2.6.1_beta_3";
    return;
end
...
L["HLP_LL_ONCLICK_TEXT"] = [=[Merci de lire la documentation pour apprendre à utiliser cet add-on. Cherchez 'Decursive' sur WoWAce.com
...
Avant de changer ces réglages, vous devriez jetez un œil aux ''|cFFFF5533Options de guérison|r' !]=]
