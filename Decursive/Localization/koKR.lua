--[[
    ...
    Decursive (v 2.7.0_beta_1) add-on for World of Warcraft UI
...
if not L then
    T._LoadedFiles["koKR.lua"] = "2.7.0_beta_1";
    return;
end;
...
L["HLP_LL_ONCLICK_TEXT"] = [=[이 애드온의 추가 기능을 사용하는 방법을 알아보려면 설명서를 읽으십시오. WoWAce.com에서 'Decursive'를 검색하세요.
(이 목록에서 Decursive 바를 이동하려면 /dcrshow 및 왼쪽-Alt-클릭으로 이동)]=] -- Needs review
...
L["OPT_CREATE_VIRTUAL_DEBUFF_DESC"] = "디버프 발생 시 어떻게 보여지는 지를 표시하도록 합니다." -- Needs review
L["OPT_CUREPETS_DESC"] = "소환수를 관리하고 해제합니다."
L["OPT_CURINGOPTIONS"] = "해제 옵션" -- Needs review
L["OPT_CURINGOPTIONS_DESC"] = "해제의 다양한 형태를 설정합니다." -- Needs review
...
L["OPT_CURINGORDEROPTIONS"] = "해제 순서 설정" -- Needs review
...
L["OPT_MFSETTINGS"] = "작은 유닛 프레임 설정" -- Needs review
L["OPT_MFSETTINGS_DESC"] = "작은 유닛 프레임에 대한 설정입니다." -- Needs review
L["OPT_MUFFOCUSBUTTON"] = "주시대상 버튼:"
L["OPT_MUFMOUSEBUTTONS"] = "마우스 버튼" -- Needs review
L["OPT_MUFMOUSEBUTTONS_DESC"] = [=[각 MUF의 경고 색상을 위해 당신이 사용하고자 하는 마우스 버튼으로 설정합니다.
이 탭을 수정하기 전에 당신이 '|cFFFF5533치유 설정|r'을 확인해야 합니다!]=] -- Needs review
L["OPT_MUFSCOLORS"] = "색상"
L["OPT_MUFSCOLORS_DESC"] = "작은 유닛 프레임의 색상을 변경합니다." -- Needs review
...
L["OPT_UNITPERLINES"] = "한줄에 표시할 유닛의 갯수" -- Needs review
L["OPT_UNITPERLINES_DESC"] = "한줄에 표시할 작은 유닛 프레임의 최대 갯수를 지정합니다." -- Needs review
