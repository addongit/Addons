...
if not L then
    DcrLoadedFiles["zhTW.lua"] = "2.4.0.2";
    return;
end;
...
L["BINDING_NAME_DCRMUFSHOWHIDE"] = "顯示或隱藏 micro-unit frames"
...
L["GLOR1"] = "紀念 Glorfindal" -- Needs review
L["GLOR2"] = "獻給匆匆離我們而去的Bertrand；他將永遠被我們所銘記。" -- Needs review
L["GLOR3"] = "紀念 Bertrand （1969～2007）" -- Needs review
L["GLOR4"] = "對於那些在魔獸世界裡遇見過Glorfindal的人來說，他是一個重承諾的男人，也是一個有超凡魅力的領袖。友誼和慈愛將永植於他們的心中。他在遊戲中就如同在他生活中一樣的無私，彬彬有禮，樂於奉獻，最重要的是他對生活充滿熱情。他離開我們的時候才僅僅３８歲，隨他離去的絕不會是虛擬世界匿名的角色；在這裡還有一群忠實的朋友在永遠想念他。" -- Needs review
L["GLOR5"] = "他將永遠被我們所銘記。" -- Needs review
