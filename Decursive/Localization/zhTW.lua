--[[
    ...
    Decursive (v 2.6.1_beta_3) add-on for World of Warcraft UI
...
if not L then
    T._LoadedFiles["zhTW.lua"] = "2.6.1_beta_3";
    return;
end;
...
L["HLP_LEFTCLICK"] = "左-鍵"
L["HLP_LL_ONCLICK_TEXT"] = "你不可以用點擊即時選單的方式解魔（因為相關的程式介面已經被封鎖），請用微縮圖像以打地鼠的方式解魔，如果你沒看見微縮圖像的話，請先檢察 Decursive 的設定。" -- Needs review
...
L["NEW_VERSION_ALERT"] = [=[已檢測到新版本的Decursive: |cFFEE7722%q|r released 於 |cFFEE7722%s|r!


請前往 |cFFFF0000WoWAce.com|r 下載!
--------]=] -- Needs review
L["NORMAL"] = "一般"
L["NOSPELL"] = "沒有可用法術"
...
L["OPT_ALLOWMACROEDIT_DESC"] = "Enable this to prevent Decursive from updating its macro, letting you edit it as you want." -- Needs review
...
L["OPT_AUTOHIDEMFS"] = "自動隱藏" -- Needs review
L["OPT_AUTOHIDEMFS_DESC"] = "選擇什麼時候隱藏 MUF 視窗" -- Needs review
...
L["OPT_DISABLEABOLISH"] = "不使用\"驅散\"法術" -- Needs review
L["OPT_DISABLEABOLISH_DESC"] = "If enabled, Decursive will prefer 'Cure Disease' and 'Cure Poison' over their 'Abolish' equivalent." -- Needs review
...
L["OPT_HIDEMFS_GROUP"] = "單獨 / 小隊" -- Needs review
L["OPT_HIDEMFS_GROUP_DESC"] = "當不在團隊中的時候隱藏 MUF 視窗" -- Needs review
L["OPT_HIDEMFS_NEVER"] = "從不" -- Needs review
L["OPT_HIDEMFS_NEVER_DESC"] = "從不自動隱藏 MUF 視窗" -- Needs review
L["OPT_HIDEMFS_SOLO"] = "單獨" -- Needs review
L["OPT_HIDEMFS_SOLO_DESC"] = "當不在團隊中或隊伍中的時候隱藏 MUF 視窗" -- Needs review
...
L["OPT_MUFMOUSEBUTTONS_DESC"] = "設定每個 MUF 滑鼠按鈕的警報顏色。" -- Needs review
L["OPT_MUFSCOLORS"] = "顏色"
L["OPT_MUFSCOLORS_DESC"] = "變更 MUFs 的顏色"
L["OPT_MUFTARGETBUTTON"] = "目標按鈕："
L["OPT_NEWVERSIONBUGMENOT"] = "新版本通知"
L["OPT_NEWVERSIONBUGMENOT_DESC"] = "如果有較新版本的Decursive被檢測到，每七天將顯示一個彈出警報。" -- Needs review
...
L["OPT_PERFOPTIONWARNING"] = "WARNING: Do not change those values unless you know exactly what you are doing. These settings can have a great impact on the game performances. Most users should use the default values of 0.1 and 10." -- Needs review
...
L["TOOFAR"] = "太遠"
L["UNITSTATUS"] = "玩家狀態: "
L["UNSTABLERELEASE"] = "不穩定釋出版" -- Needs review
