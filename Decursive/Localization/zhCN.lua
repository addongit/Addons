...
if not L then
    T._LoadedFiles["zhCN.lua"] = "2.6.1_beta_3";
    return;
end;
...
L["OPT_AUTOHIDEMFS"] = "自动隐藏" -- Needs review
L["OPT_AUTOHIDEMFS_DESC"] = "选择何时自动隐藏微单元面板（MUF）" -- Needs review
...
L["OPT_HIDEMFS_GROUP"] = "单人/小队" -- Needs review
L["OPT_HIDEMFS_GROUP_DESC"] = "不在团队中时隐藏微单元面板（MUF）" -- Needs review
L["OPT_HIDEMFS_NEVER"] = "从不" -- Needs review
L["OPT_HIDEMFS_NEVER_DESC"] = "从不隐藏" -- Needs review
L["OPT_HIDEMFS_SOLO"] = "单人" -- Needs review
L["OPT_HIDEMFS_SOLO_DESC"] = "在没有组队或者团队时隐藏微单元面板（MUF）" -- Needs review
...
L["OPT_MUFMOUSEBUTTONS_DESC"] = "设置每个 MUF 鼠标按钮的警报颜色。" -- Needs review
L["OPT_MUFSCOLORS"] = "颜色"
