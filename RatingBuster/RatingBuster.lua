...
LastUpdate: $Date: 2011-04-21 16:45:28 +0000 (Thu, 21 Apr 2011) $
]]
...
RatingBuster.version = "1.6.0 (r"..gsub("$Revision: 340 $", "$Revision: (%d+) %$", "%1")..")"
RatingBuster.date = gsub("$Date: 2011-04-21 16:45:28 +0000 (Thu, 21 Apr 2011) $", "^.-(%d%d%d%d%-%d%d%-%d%d).-$", "%1")
