...
-- 	Define the options panel
	...
	function LeaPlusOptionsPanel:OptionsPanel()
		...
		LeaPlusCheckbox("LeaPlusOldChat", 		"Use classic chat", 			200, -212, 	"If checked, you can press enter to talk in group chat using whatever method you used last (say, party, guild, etc).  To reply to whispers, press R as normal.")
		...
		LeaPlusTimer:SetPoint("BOTTOMLEFT", 20, 290)
