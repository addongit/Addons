...
-- 	Define the options panel
	...
	function LeaPlusOptionsPanel:OptionsPanel()
		...
		LeaPlusCheckbox("LeaPlusDisBP", 		"Prevent bag automation",		16, -272, 	"If checked, bags will not be opened and closed automatically when using a vendor or mailbox, allowing you to open and close them freely at your command.")
		LeaPlusCheckbox("LeaPlusPlayerGold", 	"Show elite chain",				16, -292, 	"If checked, your player portrait will have an elite gold chain around it.")
