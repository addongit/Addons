...
PawnUIFrame_UpgradeOptionsHeaderLabel_Text = "Upgrade options"
...
PawnUIFrame_EnchantedValuesCheck_Tooltip = "Enable this option to have Pawn show values for items exactly as they are, including all enchantments, gems, and reforged stats if present.  Empty sockets are ignored.\n\nIf the current value and base value are both visible and not equal, the current value will be shown first."
...
PawnRegexes =
{
	...
	{"^Prismatic Socket$", "RedSocket", 1, PawnMultipleStatsFixed}, -- *** for now this is fine since prismatic sockets don't come with socket bonuses
	...
	-- ========================================
	{'^"'}, -- Flavor text
	{"^Equip: Experience gained"}, -- Heirloom items
