...
L["Control the targets of your actions based on advanced macro conditions."] = "以你的高级的宏条件为基础控制目标行动。"
...
L["Its simple! Just check the Keyring option in the BagBars configuration menu, and it'll appear next to your bags."] = "很简单！只需点击背包配置菜单的钥匙链选项，它会出现在你的背包旁边。"
L["Key Bindings"] = "按键绑定"
L["Keyring"] = "钥匙链"
L["Layout"] = "布局"
L["Left"] = "左"
...
L["My BagBar does not have the Keyring on it, how do i get it back?"] = "我的背包栏上不显示按键绑定，我怎么让它们回来？"
L["No Display"] = "不显示"
