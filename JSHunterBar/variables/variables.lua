...
JSHB.defaults = {
	["main"] = {
		...
		["indicatorBarAnchorPoint"] 		= "CENTER",
		["indicatorBarAnchorPointRelative"] = "CENTER",
		["indicatorBarAnchorPointOffsetX"] 	= 0,
		["indicatorBarAnchorPointOffsetY"] 	= -110,
	},
...
JSHB.mdframeinfo = {
	...
	["raid"] = {
		...
		{ "CompactRaidGroup", "Member", "", 1, 10, 1, 10 },
		-- TukUI Frames
		...
		{ "SUFHeaderraid", "UnitButton", "", 1, 8, 1, 40 },
