...
L["CONFIGDESC"] = "Открыть окно настройки для Skillet"
L["Clear"] = "Очистить"
L["Config"] = "Настройки"
...
L["DISPLAYSGOPPINGLISTATAUCTIONDESC"] = "Показывать список закупок пердметов, которых у вас нет, нужных для создания рецептов."
L["DISPLAYSGOPPINGLISTATAUCTIONNAME"] = "Пказывать список закупок на аукционе"
L["DISPLAYSHOPPINGLISTATBANKDESC"] = "Показывать список закупок пердметов, которых у вас нет, нужных для создания рецептов."
L["DISPLAYSHOPPINGLISTATBANKNAME"] = "Показывать список закупок в банке"
L["DISPLAYSHOPPINGLISTATGUILDBANKDESC"] = "Показывать список закупок пердметов, которых у вас нет, нужных для создания рецептов."
...
L["SHOWBANKALTCOUNTSNAME"] = "Включаnm содержимое банка и инвентаря альтов"
...
L["SHOWFULLTOOLTIPDESC"] = "Показать всю информацию о создоваемом предмете. Если вы отключите это, то вы будете видеть только сжатую подсказку (чтобы просмотреть полную подсказку, удерживайте Ctrl)"
