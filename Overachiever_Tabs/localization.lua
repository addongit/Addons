...
L["SEARCH_DESC"] = "내용:"
L["SEARCH_FULLLIST"] = "모든 업적 검색" -- Needs review
...
L["WATCH_CLEAR"] = "지우기"
L["WATCH_COPY"] = "복사"
L["WATCH_COPY_TIP"] = "체크했을 때, 이 탭의 업적을 |cffffffffshift+alt+좌클릭|r하면, 지정된 주시 목록에 추가됩니다."
L["WATCH_DEFAULTLIST"] = "기본 주시 목록:"
L["WATCH_DEFAULTLIST_TIP"] = "지정된 목록이 각 세션의 처음에 표시된 목록입니다."
L["WATCH_DELETE"] = "삭제"
L["WATCH_DISPLAYEDLIST"] = "표시된 목록:"
L["WATCH_EMPTY"] = "주시 목록이 비었습니다. 주시하려는 다른 탭의 업적이나 업적의 대화창 링크를 Alt+좌클릭하세요."
L["WATCH_EMPTY_SHORT"] = "빈 목록"
L["WATCH_HELP"] = "다른 탭의 업적이나 업적 링크를 |cffffffffAlt+좌클릭|r하여 주시 항목을 만드세요. 더 이상 주시하지 않으려면 여기 표시된 업적을 |cffffffffAlt+좌클릭|r하세요."
L["WATCH_LIST_GLOBAL"] = "전 캐릭터"
L["WATCH_LIST_PERCHAR"] = "특정 캐릭터"
L["WATCH_NEW"] = "새로"
L["WATCH_POPUP_CLEARLIST"] = "정말로 현재 업적 주시 목록의 내용을 지울까요? "
L["WATCH_POPUP_DELETELIST"] = "정말로 현재 업적 주시 목록을 영원히 삭제할까요?"
L["WATCH_POPUP_NEWLIST"] = "새 업적 주시 목록의 이름을 입력하세요:"
L["WATCH_TAB"] = "주시"
L.SUBZONES = {
	-- ["Argent Pavilion"] = "",
	-- ["Argent Tournament Grounds"] = "",
