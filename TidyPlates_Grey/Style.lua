...
local WidgetConfig = {}
WidgetConfig.ClassIcon = { anchor = "TOP" , x = -24 ,y = 5 }
WidgetConfig.TotemIcon = { anchor = "TOP" , x = -24 ,y = 5 }
...
do
	...
	local ThemeName = "Grey/|cFF3782D1Tank"
	TidyPlatesThemeList[ThemeName] = TankTheme
