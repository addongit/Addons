...
L["Icon scaling, this lets you enlarge or shrink your icons on both the World Map and Minimap."] = "세계 지도과 미니맵에 표시되는 아이콘의 크기를 설정합니다."
L["Icons"] = "아이콘 설정"
...
L["Toggle showing Minimap icon tooltips."] = "미니맵의 노드 아이콘에 대한 툴팁을 표시합니다."
