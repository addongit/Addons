...
所有的功能是建立在交易所介面上，所以你只要開啟交易所馬上就能使用新功能了！]=],
	...
	AUCTION_FRAME_TITLE = "Advanced AuctionHouse <VERSION> - Venice (Taiwan)",
	AUCTION_LOADED_MESSAGE = "已讀取：Advanced AuctionHouse <VERSION> by Venice (Taiwan)",
...
支援滑鼠滾輪捲動。]=],
	...
	SETTINGS_MAX_SAVED_HISTORY = "儲存的歷史價格之最大單位：",
	SETTINGS_MAX_SAVED_HISTORY_HEADER = "儲存的歷史價格之最大單位",
