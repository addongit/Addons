...
All functionality is directly built into the auctionframe so you don't have to do anything but open the auctionhouse and you can use the new functions right away.]=], -- Requires localization
	...
	AUCTION_FRAME_TITLE = "Advanced AuctionHouse <VERSION> by Mavoc (EN)", -- Requires localization
	AUCTION_LOADED_MESSAGE = "Addon loaded: Advanced AuctionHouse <VERSION> by Mavoc (EN)", -- Requires localization
...
The following special filters can be used:]=], -- Requires localization
