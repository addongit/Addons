...
local fontsize = 13;
local font = ArtworkPath.."Qlassik_TB.ttf";  local NameTextVerticalAdjustment = -8; fontsize = 11;
...
--local font = ArtworkPath.."KingRichard.ttf"; local NameTextVerticalAdjustment = -9
local EmptyTexture = ArtworkPath.."Neon_Empty"
local CastBarVerticalAdjustment = -25
...
local WidgetConfig = {}
WidgetConfig.ClassIcon = { anchor = "TOP" , x = 0 ,y = 3 }
WidgetConfig.TotemIcon = { anchor = "TOP" , x = 0 ,y = 3 }
