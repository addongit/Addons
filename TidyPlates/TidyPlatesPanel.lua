...
local function ActivateInterfacePanel()
	...
	panel.AllowOverlap:SetScript("OnClick", function(self) 	if self:GetChecked() then SetCVar("nameplateMotion", 3) else SetCVar("nameplateMotion", 1) end end)
	...
	local function RefreshPanel()
		...
		if tonumber(GetCVar("nameplateMotion")) == 3 then panel.AllowOverlap:SetChecked(true) else panel.AllowOverlap:SetChecked(false) end	
...
ApplyPanelSettings = function()
	...
	-- Overlap
	if panel.AllowOverlap:GetChecked() then SetCVar("nameplateMotion", 3)
	else SetCVar("nameplateMotion", 1) end
